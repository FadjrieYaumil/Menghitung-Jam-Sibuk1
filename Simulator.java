...
public static void main(String[] args) {
        ...
        System.out.println(Fairuzikun.nama + "Seorang asdos dengan jam sibuk" + Fairuzikun.getJamSibuk());

        Asdos Angel = new Asdos("Angel-chan", 20, 4);
        System.out.println(Angel.nama + "Seorang asdos dengan jam sibuk" + Angel.getJamSibuk());
        
        Dosen Raja = new Dosen("Raja OP Damanik", 5);
        System.out.println(Raja.nama + "Seorang dosen dengan jam sibuk" + Raja.getJamSibuk());

        Mahasiswa Firman = new Mahasiswa ("Firman", 20);
        System.out.println(Firman.nama + "Seorang mahasiswa dengan jam sibuk" + Firman.getJamSibuk());

        Mahasiswa Nidtopas = new Mahasiswa ("Nid to pass this sem", 23);
        System.out.println(Nidtopas.nama + "Seorang mahasiswa dengan jam sibuk" + Nidtopas.getJamSibuk());

        Dosen Nivotko = new Dosen("Nivotko", 3);
        System.out.println(Nivotko.nama + "Seorang dosen dengan jam sibuk" + Nivotko.getJamSibuk());
